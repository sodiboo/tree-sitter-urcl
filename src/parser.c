...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    case 0:
      ...
      if (sym_char_value_character_set_1(lookahead)) ADVANCE(128);
    ...
    case 1:
      ...
      if (lookahead == '\\') ADVANCE(19);
      if (sym_string_segment_character_set_1(lookahead)) ADVANCE(99);
      if (lookahead != 0 &&
          lookahead != '\n') ADVANCE(100);
      END_STATE();
    case 2:
    ...
    case 6:
      ...
      if (sym_char_value_character_set_1(lookahead)) ADVANCE(42);
      if (('A' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_' ||
    ...
    case 8:
      ...
      if (sym_string_segment_character_set_1(lookahead)) ADVANCE(42);
      END_STATE();
    case 9:
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [53] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_instruction, 3, .production_id = 27),
  ...
  [63] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_file, 2, .production_id = 14),
  [65] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, .production_id = 19),
  [67] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, .production_id = 19), SHIFT_REPEAT(9),
  ...
  [76] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2, .production_id = 19), SHIFT_REPEAT(29),
  [79] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2, .production_id = 19), SHIFT_REPEAT(33),
  ...
  [91] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2, .production_id = 19), SHIFT_REPEAT(9),
  [94] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_instruction, 2, .production_id = 20),
  [96] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_instruction, 1, .production_id = 1),
  ...
  [109] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_instruction_repeat1, 2, .production_id = 22), SHIFT_REPEAT(80),
  [112] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_instruction_repeat1, 2, .production_id = 22), SHIFT_REPEAT(73),
  [115] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_instruction, 2, .production_id = 7),
  ...
  [122] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_array_repeat1, 2), SHIFT_REPEAT(83),
  [125] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_array_repeat1, 2), SHIFT_REPEAT(86),
  ...
  [133] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_array_repeat1, 2), SHIFT_REPEAT(51),
  [136] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_array_repeat1, 2), SHIFT_REPEAT(75),
  ...
  [168] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string, 3),
  [170] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_string, 3),
  ...
  [180] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_array, 3, .production_id = 29),
  [182] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_array, 3, .production_id = 29),
  [184] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_array, 2),
  [186] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_array, 2),
  [188] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_placeholder, 3),
  [190] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_placeholder, 3),
  ...
  [205] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__newline, 2), SHIFT_REPEAT(76),
  ...
  [234] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, .production_id = 2),
  [236] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2, .production_id = 2),
  [238] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_DW_repeat1, 2, .production_id = 15),
  [240] = {.entry = {.count = 1, .reusable = true}}, SHIFT(41),
  [242] = {.entry = {.count = 1, .reusable = true}}, SHIFT(82),
  [244] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_DW_repeat1, 2, .production_id = 15),
  [246] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__newline, 2), SHIFT_REPEAT(41),
  [249] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__newline, 2), SHIFT_REPEAT(82),
  [252] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_DW_repeat1, 2, .production_id = 21),
  [254] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_DW_repeat1, 2, .production_id = 21),
  [256] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_DW_repeat1, 2, .production_id = 21), SHIFT_REPEAT(81),
  ...
  [265] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_file, 3, .production_id = 25),
  ...
  [273] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_file, 2, .production_id = 17),
  [275] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_file, 2, .production_id = 18),
  [277] = {.entry = {.count = 1, .reusable = true}}, SHIFT(34),
  [279] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_file, 2, .production_id = 12),
  [281] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_file, 2, .production_id = 11),
  ...
  [289] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_string_repeat1, 2),
  [291] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_string_repeat1, 2), SHIFT_REPEAT(52),
  [294] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_repeat1, 2), SHIFT_REPEAT(52),
  [297] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_file, 1, .production_id = 2),
  [299] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_file, 1, .production_id = 3),
  [301] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_file, 1, .production_id = 4),
  [303] = {.entry = {.count = 1, .reusable = true}}, SHIFT(27),
  [305] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_file, 2, .production_id = 13),
  ...
  [315] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_file, 3, .production_id = 24),
  [317] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_BITS, 3, .production_id = 23),
  [319] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_MINREG, 2, .production_id = 8),
  [321] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_BITS, 2, .production_id = 8),
  [323] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_DW, 3, .production_id = 28),
  [325] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_DW, 2, .production_id = 8),
  [327] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_RUN, 2, .production_id = 9),
  [329] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_MINHEAP, 2, .production_id = 8),
  [331] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_MINSTACK, 2, .production_id = 8),
