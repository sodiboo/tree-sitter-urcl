...
enum {
  ...
  aux_sym_define_word_repeat1 = 52,
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [150] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_define_word_repeat1, 2),
  [152] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_define_word_repeat1, 2),
  [154] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_define_word_repeat1, 2), SHIFT_REPEAT(69),
  ...
  [177] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_define_word_repeat1, 1),
  [179] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_define_word_repeat1, 1),
  ...
  [221] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_define_word, 2, .production_id = 7),
  ...
  [231] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_define_word, 3, .production_id = 24),
