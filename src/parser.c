...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [168] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_char, 3, .production_id = 30),
  [170] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_char, 3, .production_id = 30),
  ...
  [188] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_array, 3, .production_id = 31),
  [190] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_array, 3, .production_id = 31),
  [192] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string, 3, .production_id = 32),
  [194] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_string, 3, .production_id = 32),
  ...
  [269] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_string_repeat1, 2, .production_id = 33),
  [271] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_string_repeat1, 2, .production_id = 33), SHIFT_REPEAT(71),
  [274] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_repeat1, 2, .production_id = 33), SHIFT_REPEAT(71),
